...
c---- convert angles in rad
      ...
      betamin = betamin/180.d0*3.14159d0
      betamax = betamax/180.d0*3.14159d0
...
c
c---- increment in beta
      dbeta = (betamax - betamin)/real(nbeta-1)
c---- loop over all beta
      do 2000 ibeta = 1,nbeta
c---- current value of beta
      beta = betamin + dbeta*real(ibeta-1)
c
...
c---- LANF is fully locked
        write(60,*) dtan(phif),beta*180.d0/3.14159d0,quD1
        write(61,*) dtan(phif),beta*180.d0/3.14159d0,1.d0
      else
c---- LANF is slipping or particially slipping
        write(60,*) dtan(phif),beta*180.d0/3.14159d0,qulower
        write(61,*) dtan(phif),beta*180.d0/3.14159d0,xzlower
c---- end of determination 
      endif
c
c---- end of loop for beta
 2000 continue
